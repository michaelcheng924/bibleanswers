const LONDON_BAPTIST = [
  {
    ...
    content: [
      ...
      [
        {
          superscript: 5,
          text: `Under the name of Holy Scripture, or the Word of God written, are now contained all the books of the Old and New Testaments, which are these:
      ...
      [
        {
          superscript: 1,
          text:
            "The Lord our God is but one only living and true God;1 whose subsistence is in and of Himself,",
