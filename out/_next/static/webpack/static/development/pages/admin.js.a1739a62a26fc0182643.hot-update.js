  ...
  _createClass(PostEditor, [{
    ...
    value: function componentDidMount() {
      ...
      _constants_confessions_london_baptist__WEBPACK_IMPORTED_MODULE_12__["default"].chapters.forEach(function (item, index) {
        if (index > 1) {
          // axios.post(
          //   `https://bibleanswersapi.herokuapp.com/posts`,
          // {
          //   slug: item.slug,
          // url: `/confessions/${item.slug}`,
          // title: `Chapter ${item.chapter}. ${item.title} - 1689 London Baptist Confession of Faith`,
          //   image_url_small: "https://i.imgur.com/AOAnpap.png",
          //   date_added: "2018-11-19",
          //   subtitle: `Chapter ${item.chapter}: ${item.title}`,
          //   tag_ids: [2, 4],
          ...
          console.log("======", {
            ...
            title: "Chapter ".concat(item.chapter, ". ").concat(item.title, " - 1689 London Baptist Confession of Faith"),
            image_url_small: "https://i.imgur.com/AOAnpap.png",
            date_added: "2018-11-19",
...
//# sourceMappingURL=admin.js.a1739a62a26fc0182643.hot-update.js.map