      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        if (data.passages) {
          return data.passages.map(function (passage, index) {
            return "".concat(passage.passage).concat(index === data.passages.length - 1 ? "" : ", ");
          });
        }

        return data.map(function (passage, index) {
          return "".concat(passage.passage).concat(index === data.length - 1 ? "" : ", ");
        });
      }), ")") : null);
    }));
  }) : react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h4", {
...
//# sourceMappingURL=contradictions.js.f0208243bf5cab7d989f.hot-update.js.map