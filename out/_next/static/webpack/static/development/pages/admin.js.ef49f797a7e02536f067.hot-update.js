...
function (_Component) {
  ...
  _createClass(PostEditor, [{
    ...
    value: function componentDidMount() {
      ...
      document.addEventListener("keyup", this.handleKeyPress); // LONDON_BAPTIST.chapters.forEach((item, index) => {
      //   if (index > 1) {
      //     axios.post(`https://bibleanswersapi.herokuapp.com/posts`, {
      //       slug: item.slug,
...
//# sourceMappingURL=admin.js.ef49f797a7e02536f067.hot-update.js.map