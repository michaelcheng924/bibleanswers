...
function (_Component) {
  ...
  function PostEditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSave", function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a[method](url, finalPost, headers).then(function () {
        _this.setState({
          success: true
        }, function () {
          setTimeout(function () {
        ...
        onFetchPostsTags().then(function () {
          if (!post.id) {
            Object(lodash__WEBPACK_IMPORTED_MODULE_4__["defer"])(function () {
              history.push("/admin/post/".concat(post.slug));
  ...
  _createClass(PostEditor, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", null, "Admin Home"), this.renderSaveButtons(), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ReadingContainer__WEBPACK_IMPORTED_MODULE_10__["default"], {
        style: {
          margin: "20px auto"
        }
...
//# sourceMappingURL=admin.js.0e59f26f261330487b9f.hot-update.js.map