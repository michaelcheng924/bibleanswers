      ...
      allPassages: [
        {
          passage: "Genesis 1",
          text: [
            `11 And God said, “<strong>Let the earth sprout vegetation, plants yielding seed, and fruit trees bearing fruit in which is their seed, each according to its kind, on the earth...</strong>” 13 And there was evening and there was morning, the third day.`,
            `24 And God said, “<strong>Let the earth bring forth living creatures according to their kinds—livestock and creeping things and beasts of the earth according to their kinds...</strong>”`,
            `26 Then God said, “<strong>Let us make man in our image, after our likeness.</strong>”`
          ]
        },
        {
          passage: "Genesis 2",
          text: [
            ...
            `18 Then the Lord God said, “It is not good that the man should be alone; I will make him a helper fit for him.” 19 <strong>Now out of the ground the Lord God had formed every beast of the field and every bird of the heavens</strong> and brought them to the man to see what he would call them.`
          ]
        }
      ]
    },
