const CHURCH_FINDERS = [
  {
    title: "Reformed Baptist Church Directory",
    subtitle:
      "A directory of churches that generally adhere to the 1689 London Baptist Confession",
    url: "http://farese.com/map",
    imageUrl: "../../static/globe.png"
  },
  {
    title: "Gospel Coalition Church Directory",
    subtitle:
      "The Gospel Coalition includes both Baptist and Presbyterian churches that are generally reformed in theology",
    url: "http://thegospelcoalition.org/churches",
    imageUrl: "../../static/tgc.png"
  },
  {
    title: "9Marks Church Search",
    subtitle: "Includes both Baptist and Presbyterian churches",
    url: "http://9marks.org/church-search",
    imageUrl: "../../static/9marks.png"
  },
  {
  ...
  },
  {
    ...
    imageUrl: "../../static/pca.png"
  }
];

export default CHURCH_FINDERS;
