...
<div class="writing>
  ...
  <p class="first">
    ...
    <ol>
      <li>
        <strong>Truth cannot be known.</strong> This position is self-contradictory.
      </li>
      <li>
        <strong>I simply do not know the truth.</strong> This position is not
        ...
        who holds this position <strong>should</strong> have a desire to pursue the
        truth.
      </li>
    </ol>
  </p>
  ...
  <p>
    ...
    known," <strong>cannot itself be known</strong>.
  </p>
  
  <img src="http://bibleanswers-backend.herokuapp.com/images/contradiction.png" class="image-left" />

  <p>
    If it is true that "truth cannot be known," then it is also true that
    "truth" <strong>can</strong> be known, since "truth" that "truth cannot be known"
    can be known. However, if truth <strong>both can and can't</strong> be known at the
...
const agnosticism = {
  ...
  imageUrl:
    "http://bibleanswers-backend.herokuapp.com/images/question-marks.png",
  imagePosition: "79% 50%",
  tags: ["worldview"],
