  ...
  _createClass(MyDocument, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("html", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_document__WEBPACK_IMPORTED_MODULE_1__["Head"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("link", {
        rel: "icon",
        href: "https://i.imgur.com/lnlvtFf.png"
      }), this.props.title, this.props.metaDescription, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("style", null, BODY_STYLES)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("body", {
    ...
    value: function getInitialProps(_ref) {
      ...
      if (req.url.indexOf("/answers") !== -1 || req.url === "/gospel") {
        ...
        var _page = renderPage(function (App) {
        ...
        var _title = _page.head.filter(function (_ref3) {
          var type = _ref3.type;
          return type === "title";
        }).slice(0, 1) || react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("title", null, "ampreact");

        var _metaDescription = _page.head.filter(function (_ref4) {
          var type = _ref4.type;
          return type === "meta";
        }).slice(1, 2) || "";

        return _objectSpread({}, _page, {
          title: _title,
      ...
      var page = renderPage(); // Get the dynamic `<title />` from the head generated by next.js

      var title = page.head.filter(function (_ref5) {
        var type = _ref5.type;
        return type === "title";
      }).slice(0, 1) || react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("title", null, "ampreact");
      var metaDescription = page.head.filter(function (_ref6) {
        var type = _ref6.type;
        return type === "meta";
      }).slice(1, 2) || "";
      return {
