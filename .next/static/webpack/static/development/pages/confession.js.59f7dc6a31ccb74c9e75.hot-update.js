...
var ScriptureRef = function ScriptureRef(_ref) {
  ...
  return data.passages.map(function (passage, index) {
    ...
    scriptureTopPassage = passageSections.reduce(function (result, match) {
      result = result.replace(match, "<strong>".concat(match, "</strong>"));
      return result;
    }, scriptureTopPassage);
...
//# sourceMappingURL=confession.js.59f7dc6a31ccb74c9e75.hot-update.js.map