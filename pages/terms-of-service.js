    ...
    <AmpContainer>
      <div className="writing">
        ...
        <p>
          ...
          use of Bible Answers's Website.
        </p>{" "}
        <br />
        <span style={{ textTransform: "capitalize" }}> Bible Answers</span> is
        located at:
        <br />
        <br />
        ...
        <p>
          ...
          conditions in full. Do not continue to use Bible Answers's website if
        ...
        <h3>Cookies</h3>
        <p>
          We employ the use of cookies. By using Bible Answers's website you
          consent to the use of cookies in accordance with Bible Answers’s
          privacy policy.
        </p>
        <p>
        ...
        <h3>License</h3>
        <p>
          Unless otherwise stated, Bible Answers and/or it’s licensors own the
          intellectual property rights for all material on Bible Answers. All
          intellectual property rights are reserved. You may view and/or print
          pages from http://bibleanswers.io for your own personal use subject to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from http://bibleanswers.io</li>
          <li>
            Sell, rent or sub-license material from http://bibleanswers.io
          </li>
          <li>
            Reproduce, duplicate or copy material from http://bibleanswers.io
          </li>
        </ol>
        <p>
        ...
        <p>
          ...
          outweighs the absence of Bible Answers; and (d) where the link is in
        ...
        <p>
          No use of Bible Answers’s logo or other artwork will be allowed for
