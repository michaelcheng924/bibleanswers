  ...
  <ReadingContainer style={{ marginBottom: 20 }}>
    <AmpContainer>
      <div className="writing">
        ...
        <p className="first">Effective date: October 22, 2018</p>

        <p>
          Bible Answers ("us", "we", or "our") operates the
          http://bibleanswers.io website (the "Service").
        </p>
        ...
        <p>
          ...
          Bible Answers is managed through{" "}
        ...
        <p>
          ...
          our Terms and Conditions, accessible from http://bibleanswers.io
        </p>
        ...
        <p>Bible Answers uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Bible Answers will take all steps reasonably necessary to ensure that
        ...
        <p>
          Bible Answers may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Bible Answers</li>
          <li>
        ...
        <ul>
          <li>
            By visiting this page on our website: http://bibleanswers.io/contact
          </li>
        </ul>
      </div>
    </AmpContainer>
